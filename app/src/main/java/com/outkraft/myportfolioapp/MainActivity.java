package com.outkraft.myportfolioapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    {
        ToastMessage(((Button)view).getText().toString());
    }

    public void ToastMessage(String msg)
    {
        Toast.makeText(getApplicationContext(), "This button will launch my " + msg +" App", Toast.LENGTH_SHORT).show();
    }
